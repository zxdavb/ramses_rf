...
_DEVICE_INFO = {
    ...
    "0002FFFF17FFFFFFFF": (DEV_KLASS.CTL, "01", "2012-05-11", "IONA RAI Prototype"),  # .           ATC928-G1-000 Evo Mk1 - Monochrone (?prototype, 8 zones)
    "0003FF0203FFFF0001": (DEV_KLASS.UFC, "02", "2017-11-06", "HCE80 V3.10 061117"),
    "0002FF0412FFFFFFFF": (DEV_KLASS.TRV, "04", "2014-03-13", "HR92 Radiator Ctrl."),
    "0002FF050BFFFFFFFF": (DEV_KLASS.TRV, "04", "2017-03-07", "HR91 Radiator Ctrl."),
    "0001C8810B0700FEFF": (DEV_KLASS.OTB, "10", "2019-08-20", "R8820"),
    "0002FF0A0CFFFFFFFF": (DEV_KLASS.OTB, "10", "2014-07-31", "R8810A Bridge"),
    "0002FF1E01FFFFFFFF": (DEV_KLASS.RFG, "30", "2013-12-04", "Internet Gateway"),
    ...
    "0001001B221201FEFF": (DEV_KLASS.FAN, "20", "2015-05-12", "CVE-RF"),  # .                       31D9, 31DA
    "0001001B271501FEFF": (DEV_KLASS.FAN, "20", "2016-11-03", "CVE-RF"),  # .                       31D9, 31DA (RP|12A0, RP|3120, both N/A)
    "0001001B281501FEFF": (DEV_KLASS.FAN, "20", "2016-11-11", "CVE-RF"),  # .                       31D9, 31DA
    ...
    "0001C83A0F0866FFFF": (DEV_KLASS.FAN, "32", "0000-00-00", "VMD-17RPS01"),  # .                  31D9, 31DA
    "0001C8950B0A67FEFF": (DEV_KLASS.FAN, "32", "2021-01-21", "VMD-15RMS86"),  # .                  31D9, 31DA, 12A0, 313F (and I|042F, I|3120)
    "0001C90011006CFEFF": (DEV_KLASS.FAN, "30", "2016-09-09", "BRDG-02JAS01"),  # .      NOTE: 30:  31D9, 31DA, 1F09 (a PIV)
    # CO2 - some have PIR
    "00010028080101FEFF": (DEV_KLASS.CO2, "37", "2019-04-29", "VMS-12C39"),  # .                    1298, 31E0, 2E10, 3120, and I|22F1!
    "00010028090101FEFF": (DEV_KLASS.CO2, "37", "2021-01-20", "VMS-12C39"),  # .                    1298, 31E0, 2E10, 3120 (and I|042F)
    "0001C822060166FEFF": (DEV_KLASS.CO2, "37", "2016-12-22", "VMS-17C01"),  # .                    1298, 31E0
    "0001C85701016CFFFF": (DEV_KLASS.CO2, "32", "2016-06-17", "VMS-23C33"),  # .                    1298, 31E0 (and I|042F)
    # HUM
    "0001C825050266FFFF": (DEV_KLASS.HUM, "29", "2017-04-19", "VMS-17HB01"),  # .                   12A0, 31E0, 1060
    "0001C85802016CFFFF": (DEV_KLASS.HUM, "32", "2016-07-12", "VMS-23HB33"),  # .                   12A0, 31E0, 1060  (and I|042F)
    "0001C85803016CFFFF": (DEV_KLASS.HUM, "32", "2016-09-12", "VMS-23HB33"),  # .                   12A0, 31E0, 1060  (and I|042F)
    # SWI
    ...
    # TBA - broken as 18:...
    "0001FA100A0001FEFE": (DEV_KLASS.FAN, "18", "2019-04-11", "BRDG-02A55"),  # .        NOTE: 18:  31D9, 31DA, 1F09
    "0001FA100B0001FEFE": (DEV_KLASS.FAN, "18", "2019-07-22", "BRDG-02A55"),  # .        NOTE: 18:  31D9, 31DA, 1F09
