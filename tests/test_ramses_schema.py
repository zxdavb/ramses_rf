...
from ramses_rf.devices_heat import HEAT_CLASS_BY_SLUG
from ramses_rf.devices_hvac import HVAC_CLASS_BY_SLUG
from ramses_rf.protocol.const import DEV_TYPE, _0418
